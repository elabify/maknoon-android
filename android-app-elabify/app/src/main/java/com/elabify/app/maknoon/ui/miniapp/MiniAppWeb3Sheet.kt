...
sealed interface MiniAppWeb3Action {
    data class Connect(val address: String) : MiniAppWeb3Action
    data class SignMessage(val preview: String) : MiniAppWeb3Action
    data class SendTransaction(val to: String, val amountEth: String, val network: String) : MiniAppWeb3Action
    ...
    companion object {
        ...
        fun parse(payloadJson: String): MiniAppWeb3Action? {
            ...
            return when (o.optString("action")) {
                "connect" -> Connect(o.optString("address"))
        ...
        MiniAppWeb3Sheet(
            ...
            onApprove = {
                scope.launch {
                    working = true
                    authError = null
                    // Connect is low-risk (the address is public): skip biometrics.
